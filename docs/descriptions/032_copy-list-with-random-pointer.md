...
- **题目链接**：[随机链表的复制](https://leetcode.cn/problems/copy-list-with-random-pointer/description/?envType=study-plan-v2&envId=top-100-liked)
...
示例 1： ![题目图示](./assets/032_copy-list-with-random-pointer_0.png)

输入： head = [[7,null],[13,0],[11,4],[10,2],[1,0]]

输出： [[7,null],[13,0],[11,4],[10,2],[1,0]]

示例 2： ![题目图示](./assets/032_copy-list-with-random-pointer_1.png)

输入： head = [[1,1],[2,1]]

输出： [[1,1],[2,1]]

示例 3： ![题目图示](./assets/032_copy-list-with-random-pointer_2.png)
